  ...
  return (
    <div className="w-full max-w-[400px]">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm" style={{ color: "var(--text-secondary)" }}>Tạo tài khoản mới ✨</p>
      </div>
      ...
      <div className="p-6 rounded-2xl" style={{ background: "var(--bg-surface)", border: "1px solid var(--border-default)", boxShadow: "0 4px 24px rgba(0,0,0,.06)" }}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-5">
            <label className="block text-xs font-semibold uppercase tracking-wide mb-1.5" style={{ color: "var(--text-secondary)" }}>Xác nhận mật khẩu</label>
            <input
      ...
      <p className="text-center mt-5 text-sm" style={{ color: "var(--text-secondary)" }}>
        Đã có tài khoản?{" "}
        <Link href="/login" className="font-semibold" style={{ color: "var(--action-primary)" }}>Đăng nhập</Link>
      </p>
    </div>
  );
}
