...
import { getLearnedWords, toggleLearnedWordAPI, fetchAllLearnedWordsAPI } from "@/lib/en9-vocab-progress";
...
export default function VocabDetailPage() {
  ...
  useEffect(() => {
    setLoading(true);
    fetch(`${API_BASE}/api/v1/exam/english/en9-vocab-topics/${topicId}`)
  ...
  return (
    <div className="vd-page">
      <nav className="vd-breadcrumb">
        ...
        <span>/</span>
        <Link href="/exam/english/en9-vocabulary">Từ vựng Lớp 9</Link>
        <span>/</span>
